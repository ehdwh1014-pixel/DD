...
### 5b) Coolint P DO4 / 여분 DO5 → NI 9477

DO0~2와 **동일 SINK 배선**. **Coolint P(DO4)**는 메인 화면에서 ON/OFF, **DO5**는 I/O TEST에서 수동 ON/OFF합니다.

| 신호 | NI 9477 |
|------|---------|
| Coolint P SIG | **DO4** (line4) |
| 여유 DO SIG | **DO5** (line5) |
| COM | PSU 0V |
...
- 메인 화면의 **I/O TEST**에서는 아래를 수동 시험합니다.
  ...
  - **DO 5** SINK ON/OFF
- **Coolint P(DO4)**는 메인 화면 **통신 / 화염** 패널(또는 터치 **화염 / 점화** 탭)에서 ON/OFF합니다.
...
- 팝업을 닫으면 AO2=0 V, DO0~2/DO5=OFF 후 레벨 자동제어로 복귀합니다. Coolint P(DO4) 상태는 유지됩니다.
...
- MP5Y가 끊겨도 NI-DAQ이 정상이면 레벨센서 자동 밸브 제어, 점화 DO, Coolint P(DO4), 메인 NG PUMP(AO1), I/O TEST의 AO2·DO5는 계속 사용할 수 있습니다.
